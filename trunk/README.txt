...
Broker_PlayedTime - a World of Warcraft user interface addon
...
Usage
	...
	The options panel can be found in the Interface Options window,
	or by right-clicking the plugin.
